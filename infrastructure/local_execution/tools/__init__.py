...
from infrastructure.local_execution.tools.web_tools import web_fetch, web_search
...
def register_tool(name: str, handler: ToolFunc) -> None:
    """Register a tool at runtime (e.g. after skill acquisition)."""
    TOOL_REGISTRY[name] = handler


__all__ = ["TOOL_REGISTRY", "ToolFunc", "register_tool"]
